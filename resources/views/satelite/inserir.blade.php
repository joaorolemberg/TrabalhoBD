...
<div class="container overflow-auto" id="containerInserir">
    ...
    {!! Form::open(['method'=> 'post','class'=> 'form-padrao'])!!}
        ...
        <div class="form-group" style="padding-left:60px;">     
            ...
            {!! Form:: text('nome',null,['id'=>'inserirForms','class'=>'form-control','placeholder'=>"Nome do satélite"])!!}
        </div>
        ...
        <div class="form-group" style="padding-left:60px;">     
            ...
            {!! Form:: text('comp_sn',null,['id'=>'inserirForms','class'=>'form-control','placeholder'=>"Composição química (Ex.: H:10%;O:60%;He:30%)"])!!}
        </div>
