...
@section('conteudo-view')
    <div class="container overflow-auto" id="containerConsultar">
        ...
        {!! Form::open(['method'=> 'post','action'=>'sateliteController@consultaAlterar','class'=> 'form-padrao'])!!}
        ...
        <div class="row"  >
            ...
            <div class="col-xl-8" style="display:flex; aling-items: center; ">
                    ...
                    {!! Form:: text('id',null,['id'=>'consultarText','class'=>'form-control','placeholder'=>"ID do satélite"])!!}
            </div>
            <div class="col-xl-4" >
