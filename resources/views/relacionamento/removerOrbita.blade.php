...
@section('conteudo-view')
    <div class="container overflow-auto" id="containerConsultar">
        ...
        <h1>Remover órbita</h1>  
        <!-- CASO FOR UTILIZAR 2 METODOS ALTERAR O METHOD SEMELHANTE AO LOGIN-->
        {!! Form::open(['method'=> 'post','action'=>'relacionamentoController@removerOrbita','class'=> 'form-padrao'])!!}
        ...
        <div class="row"  >
            ...
            <div class="col-xl-8" style="display:flex; aling-items: center; ">
                    ...
                    {!! Form:: text('id',null,['id'=>'consultarText','class'=>'form-control','placeholder'=>"ID da órbita"])!!}
            </div>
            <div class="col-xl-4" >
